...
# ------------------------------------------------------------------------- #
    ...
    <div id="relatorios">
        <form method="post" action="<?= $Esta_Pagina ?>">
            ...
            <input type="hidden" name="listar" id="l1" value="0" <?= $listar == 0 ? 'checked="checked" ' : '' ?>/><!--<font id="ll1">TODOS OS USUÁRIOS</font>
            ...
            <input type="radio" name="listar" id="l3" value="2" style="margin-left:40px;" <?= $listar == 2 ? 'checked="checked" ' : '' ?>/><font id="ll3">NÃO ALUNOS</font>-->
            <input type="radio" name="opcao" value="1" <?= $opcao == 1 ? 'checked="checked" ' : 'checked="checked' ?>onclick="unlock();" />USUÁRIOS CADASTRADOS.<br/><br/>
            FILTRAR POR DOCUMENTO OU NOME: 	    <input type="text" name="busca" value="<?= $opcao == 2 ? '' : $busca ?>"/>
            <hr style="border:1px #a5a5a5 dashed;margin:15px 0px;" />
            <input type="radio" name="opcao" value="2" <?= $opcao == 2 ? 'checked="checked" ' : '' ?>onclick="unlock();" />USUÁRIOS INSCRITOS POR EVENTO:
